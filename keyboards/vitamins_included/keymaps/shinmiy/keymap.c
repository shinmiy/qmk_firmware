...
[_LEFT] = LAYOUT_ortho_4x12( \
  KC_BSPC, KC_P,    KC_O,    KC_I,    KC_U,    KC_Y,    _______, _______, _______, _______, _______, _______, \
  KC_ENT , KC_SCLN, KC_L,    KC_K,    KC_J,    KC_H,    _______, _______, _______, _______, _______, _______, \
  JA_ENUN, KC_SLSH, KC_DOT,  KC_COMM, KC_M,    KC_N,    _______, _______, _______, _______, _______, _______, \
